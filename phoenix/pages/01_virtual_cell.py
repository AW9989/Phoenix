...
def main() -> None:
    ...
    if config.reference_electrode:
        st.info(
            ...
            "records potentials relative to the electrolyte potential at that "
            "separator reference point, not automatically versus Li/Li⁺. Phoenix "
            "adds electrode-resolved plots, "
